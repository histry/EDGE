...
OUT="${V26_OUT_DIR:-output/v29_whole_song_$(date +%Y%m%d_%H%M%S)}"
ARGS=()
...
# V29 transition runtime defaults. All can be overridden externally.
...
export V29_TRANSITION_PRESERVE_CONTACTS="${V29_TRANSITION_PRESERVE_CONTACTS:-1}"
export V29_TRANSITION_SEED="${V29_TRANSITION_SEED:-20260610}"

python tools/schedule_v29_whole_song.py \
...
echo "[PASS] V29 whole-song output: $OUT"
