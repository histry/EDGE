...
OUT="$RUN_ROOT/dunhuangwu2_v46_MotionRAG_Diff_regen.npy"
JSON="$RUN_ROOT/dunhuangwu2_v46_MotionRAG_Diff_regen.report.json"
MP4="$RUN_ROOT/dunhuangwu2_v46_MotionRAG_Diff_regen.mp4"
