...
export V34_OUTPUT_SMOOTH="${V34_OUTPUT_SMOOTH:-1}"
export V34_OUTPUT_ROT_SMOOTH_WINDOW="${V34_OUTPUT_ROT_SMOOTH_WINDOW:-3}"
export V34_OUTPUT_ROOT_Y_SMOOTH_WINDOW="${V34_OUTPUT_ROOT_Y_SMOOTH_WINDOW:-5}"
export V34_OUTPUT_SMOOTH_STRENGTH="${V34_OUTPUT_SMOOTH_STRENGTH:-0.35}"
