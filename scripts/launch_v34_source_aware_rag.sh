...
export V34_EDGE_HUB_TOP_K="${V34_EDGE_HUB_TOP_K:-128}"
export V34_SOURCE_DIVERSE_RESCUE="${V34_SOURCE_DIVERSE_RESCUE:-1}"
export V34_SOURCE_DIVERSE_PER_GROUP="${V34_SOURCE_DIVERSE_PER_GROUP:-1}"
export V34_SOURCE_DIVERSE_MAX_GROUPS="${V34_SOURCE_DIVERSE_MAX_GROUPS:-96}"
...
export V34_POSTPROCESS_USE_SMPL_FK="${V34_POSTPROCESS_USE_SMPL_FK:-1}"
export V34_POSTPROCESS_FK_DEVICE="${V34_POSTPROCESS_FK_DEVICE:-cuda}"
export V34_KINEMATIC_CONTACT_INFER="${V34_KINEMATIC_CONTACT_INFER:-1}"
export V34_KIN_CONTACT_VOTE_THRESHOLD="${V34_KIN_CONTACT_VOTE_THRESHOLD:-2}"
export V34_KIN_CONTACT_MIN_FRAMES="${V34_KIN_CONTACT_MIN_FRAMES:-3}"
...
export V34_FLOOR_SUPPORT_DAMPING="${V34_FLOOR_SUPPORT_DAMPING:-0.18}"
