...
EXP_NAME="${EXP_NAME:-stationary_v3c_whitelist24_visibleFK_x0w03}"
PROJECT="${PROJECT:-runs/train_nextgen}"
CHECKPOINT="${CHECKPOINT:-runs/train_nextgen/strict_single_unit45_recon_v16_smooth_dense8_from_v15/weights/train-5000.pt}"
...
export EDGE_V3C_VISIBLE_FK_WEIGHT="${EDGE_V3C_VISIBLE_FK_WEIGHT:-10.0}"
export EDGE_V3C_ACTIVITY_FLOOR="${EDGE_V3C_ACTIVITY_FLOOR:-0.70}"
export EDGE_V3C_RANGE_FLOOR="${EDGE_V3C_RANGE_FLOOR:-0.65}"
...
export EDGE_V3C_FK_ACTIVITY_WEIGHT="${EDGE_V3C_FK_ACTIVITY_WEIGHT:-3.0}"
export EDGE_V3C_FK_RANGE_WEIGHT="${EDGE_V3C_FK_RANGE_WEIGHT:-2.0}"
export EDGE_V3C_FK_HAND_WEIGHT="${EDGE_V3C_FK_HAND_WEIGHT:-1.0}"
export EDGE_V3C_FK_HAND_RANGE_WEIGHT="${EDGE_V3C_FK_HAND_RANGE_WEIGHT:-2.0}"
export EDGE_V3C_VISIBLE_FK_DEBUG="${EDGE_V3C_VISIBLE_FK_DEBUG:-1}"

export EDGE_X0_RECON_LOSS=1
export EDGE_X0_RECON_LOSS_WEIGHT="${EDGE_X0_RECON_LOSS_WEIGHT:-0.3}"
...
echo "==== V3C FK-visible upper-body training ===="
