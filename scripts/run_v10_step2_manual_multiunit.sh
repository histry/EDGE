...
: "${EDGE_V10_MANUAL_MID_FRAMES:=50,100}"
export EDGE_V10_MANUAL_MID_FRAMES
...
if [ -z "${EDGE_V10_MANUAL_MID_POSES:-}" ]; then
  echo "ERROR: set EDGE_V10_MANUAL_MID_POSES=/path/mid1.npy,/path/mid2.npy"
  exit 2
fi
...
python generate_v10_choreo.py \
  ...
  --no_tto \
  --out output/v10_eval/v10_step2_manual_wu2.npy
