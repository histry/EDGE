...
# Step 4 is auto mode.  Clear Step2 manual controls so exported shell vars do not leak.
...
export EDGE_V10_OUT_PREFIX="${EDGE_V10_OUT_PREFIX:-output/v10_eval/v10_step4_auto_multiunit_wu2}"
