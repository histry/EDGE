...
# 手动安装 recon patch，因为本脚本直接 import EDGE，不经过 generate_controlled_v9 guard。
try:
...
CKPT = "runs/train_nextgen/strict_single_unit45_recon_v12_full_lr5e5_10000steps_b1/weights/train-10000.pt"
...
# 关键修正：Dataset 必须使用 checkpoint/model normalizer。
ds = DunhuangDataset(
    DATA_DIR,
    train=True,
    seq_len=45,
...
print("\n=== teacher-forced denoise replay with checkpoint normalizer ===")
with torch.no_grad():
