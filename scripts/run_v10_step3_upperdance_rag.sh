...
export EDGE_UNIT_PRIOR_STRENGTH="${EDGE_UNIT_PRIOR_STRENGTH:-0.02}"
...
export EDGE_V10_MODE=upperdance_rag
export EDGE_V10_SCORE_UPPER_W="${EDGE_V10_SCORE_UPPER_W:-0.55}"
export EDGE_V10_SCORE_TURN_W="${EDGE_V10_SCORE_TURN_W:-0.20}"
export EDGE_V10_SCORE_DIVERSITY_W="${EDGE_V10_SCORE_DIVERSITY_W:-0.20}"
export EDGE_V10_SCORE_ROOT_PENALTY_W="${EDGE_V10_SCORE_ROOT_PENALTY_W:-0.10}"
export EDGE_V10_AUTO_MID_COUNT="${EDGE_V10_AUTO_MID_COUNT:-2}"
export EDGE_V10_MID_FRAMES="${EDGE_V10_MID_FRAMES:-50,100}"
export EDGE_V10_MID_STRENGTH="${EDGE_V10_MID_STRENGTH:-0.06}"
export EDGE_V10_KEYFRAME_WIDTH="${EDGE_V10_KEYFRAME_WIDTH:-0}"
export EDGE_V10_OUT_PREFIX="output/v10_eval/v10_step3_upperdance_wu2"
...
python generate_v10_choreo.py \
  ...
  --no_tto \
  --out output/v10_eval/v10_step3_upperdance_wu2.npy
