...
CATEGORY_PROFILES: Dict[str, Dict[str, Any]] = {
    "thirty_six_postures": {
        "aliases": {"36pose", "36posture", "36postures", "thirtysix", "thirty_six", "thirty_six_postures"},
...
def make_report(records: List[Dict[str, str]], groups: Dict[str, Dict[str, Any]], assignment: Dict[str, str], args: argparse.Namespace) -> Dict[str, Any]:
    ...
    return {
        "version": "v46_17_official_chang_e_source_split",
...
def write_ontology(out_dir: Path) -> None:
    obj = {
        "version": "v46_17_chang_e_label_ontology",
...
def main() -> None:
    ...
    preferred_fields = [
        ...
        "preferred_dance_keys", "raw_stem", "raw_manifest_index", "raw_manifest_path",
    ]
