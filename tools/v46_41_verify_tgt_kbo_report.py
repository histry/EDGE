#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Verify V46.41 Stage-Anchored TGT/KBO report."""
...
def main() -> int:
    ...
    summary = r.get("v46_41_tgt_kbo_summary", {})
    if args.require_v46_41_tokens and not isinstance(tx, list):
        errors.append("missing v46_41_temporal_generative_transactions list")
    if args.require_v46_41_tokens and not summary:
