...
FILES = [
    ...
    "tools/check_v34_warp_feasibility.py",
...
def main() -> None:
    ...
    parser.add_argument("--patch_root", default=str(Path(__file__).resolve().parent))
    ...
    backup = edge / ("backup_v34_1_" + datetime.now().strftime("%Y%m%d_%H%M%S"))
    ...
    print("[DONE] V34.1 warp-budget negotiation patch installed")
